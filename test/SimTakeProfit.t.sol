...
contract TakeProfitsHookTest is Test, Deployers {
    ...
    //     assertEq(
    //         token1.balanceOf(address(this)) - originalToken1Balance,
    ...
    //     console.log("tokensLeftToSell : ", tokensLeftToSell);
    ...
    // function test_multiple_orderExecute_zeroForOne_then_oneForZero() public {
    //     PoolSwapTest.TestSettings memory testSettings = PoolSwapTest
    //         .TestSettings({takeClaims: false, settleUsingBurn: false});
    ...
    //     tokensLeftToSell = hook.pendingOrders(key.toId(), -60, false);
    //     assertEq(tokensLeftToSell, 0);

    //     hook.redeem(key, 0, true, amount);
    //     hook.redeem(key, 60, true, amount);
    //     hook.redeem(key,-60, false, amount * 2);
